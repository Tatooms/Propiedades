...
map.getView().fit([-967108.781891, 5250668.803740, -966835.966162, 5250907.620851], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Relación de parcelas </h2>';
        return titleElement;
    })(),
